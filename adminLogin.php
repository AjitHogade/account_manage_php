...
<body>
 <!-- <?php //include("header.php") ?> -->
          ...
          <div style = "color:white;padding:10px">
				<h3>Personal-Records<h3></div>
                    <div style = "color:white;margin-top:-40px;margin-right:10px;float:right">
                        <a href="memberLogin.php" style="color:white">Member-Login</a></div></nav>
            </header> <br><br>
            <div class="container">
            <div class="row">
  ...
  <div class="panel-body">    
      <div  class="form">
    		<form id="contactform" form name ="login" form action = "a_verifyLogin.php" onsubmit = "return Validate()" method = "post"> 
